            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="/images/titanium-design.jpg" alt="iphone titanium"></img>
                    ...
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="/images/ios-features.jpg" alt="ios 2025"></img>
                ...
                <div className="bg-gray-900 rounded-3xl p-8 mb-16" id="performance">
                    ...
                    <img className="w-full rounded-2xl mb-4" src="/images/chip-a18-pro.jpg" alt="chip a18"></img>
