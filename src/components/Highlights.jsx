import titaniumImg from '../assets/images/titanium-design.jpg';
import iosFeaturesImg from '../assets/images/ios-features.jpg';
import chipA18Img from '../assets/images/chip-a18-pro.jpg';
        ...
        <section className="bg-black py-20 px-6" id="design">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-400">Cada detalhe foi pensado para criar a melhor expreiência</p>
                </div>

                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src={titaniumImg} alt="iphone titanium"></img>
                    ...
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src={iosFeaturesImg} alt="ios 2025"></img>
                        <h3 className="font-bold mb-2 text-2xl md:text-3xl">iOS 26</h3>
                        <p className="text-gray-300">O sistema operacional mais avanado do mundo com IA integrada.</p>
                    </div>
                </div>
                ...
                <div className="bg-gray-900 rounded-3xl p-8 mb-16" id="performance">
                    ...
                    <p className="text-gray-300 mb-6">O chip mias poderoso em um smartphone</p>
                    <img className="w-full rounded-2xl mb-4" src={chipA18Img} alt="chip a18"></img>
